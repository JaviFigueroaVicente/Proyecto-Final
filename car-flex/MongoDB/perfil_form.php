...
echo '<form action="perfil_modificar.php" method="post" enctype="multipart/form-data" id="EditarPerfil">
    <fieldset>
        ...
        <div>
            ...
            <input type="text" id="NuevoUsuario" name="NuevoUsuario" placeholder="Escribe tu nuevo usuario" value="' . $_SESSION['usuari_nom'] . '">
        </div>
        <div>
            <label for="NuevoNombre">Cambiar Nombre</label>
            <input type="text" name="NuevoNombre" id="NuevoNombre" placeholder="Nuevos Nombre" value="' . $nombre . '">
        </div>
        <div>
            <label for="NuevoApellido1">Cambiar Apellidos</label>
            <input type="text" name="NuevoApellido1" id="NuevoApellido1" placeholder="Nuevo Primer Apellido" value="' . $Apellido . '">
        ...
        <div>
            ...
            <input type="email" name="NuevoCorreo" id="NuevoCorreo" placeholder="Nuevo Correo Eléctronico" value="' . $correo . '">
        ...
        <div id="PerfilBottom">
            ...
            <input type="password" name="NuevaContraseña" id="NuevaContraseña" placeholder="Nueva Contraseña" pattern="[a-zA-Z-*-_-/-]{8,128}" value="' . $Contrasena . '">
